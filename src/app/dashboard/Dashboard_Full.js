...
export class Dashboard extends Component { 
  ...
  sessionsChannelChartData = {
    labels: ['MIA', 'Technology Selection', 'Collaborator Center', 'Knowledge Center', 'Other'],
    datasets: [{
      data: [25,20,30,15,10],
          ...
          <div className="az-content-body">
            <div className="az-dashboard-one-title">
              <div>
                ...
                <p className="az-dashboard-text font-italic">“Creativity is thinking up new things. Innovation is doing new things.“ - Theodore Levitt</p>
              </div>
              <div className="az-content-header-right" style={{border: '1px solid #cdcdcd', padding: '1rem'}}>
                <div className="media">
                ...
                <a href="#/" className="btn btn-purple"><i className="typcn typcn-lightbulb"></i> Explore</a>
              </div>
            ...
            <div className="az-dashboard-nav">
              <nav className="nav">
                ...
                <a className="nav-link" data-toggle="tab" href="#/">Audience</a>
                <a className="nav-link" data-toggle="tab" href="#/">Idea</a>
              ...
              <div className="col-lg-7 ht-lg-100p">
                <div className="card card-dashboard-one">
                  <div className="card-header">
                    <div>
                      <h6 className="card-title">Center of Excellence - Audience Metrics</h6>
                ...
                <div className="card card-dashboard-pageviews">
                  ...
                  <div className="card-body">
                    <div className="az-list-item">
                      <div>
                        <h6>MIA - Submission</h6>
                        <span>/mia/submission/index.html</span>
                      </div>
                      <div>
                    ...
                    <div className="az-list-item">
                      <div>
                        <h6>Technology Selection - Registration</h6>
                        <span>/tech/registration/index.html</span>
                      </div>
                      <div>
                    ...
                    <div className="az-list-item">
                      <div>
                        <h6>MIA - Reviewing</h6>
                        <span>/mia/reviewing/index.html</span>
                      </div>
                      <div>
                    ...
                    <div className="az-list-item">
                      <div>
                        ...
                        <span>/knowledge-center/index.html</span>
                      </div>
                      <div>
                ...
                <div className="card card-table-one">
                  ...
                  <div className="table-responsive">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <td><i className="flag-icon flag-icon-id flag-icon-squared"></i></td>
                        ...
                        <tr>
                          <td><i className="flag-icon flag-icon-sg flag-icon-squared"></i></td>
