              ...
              {/* <div className="col-lg-6 ht-lg-100p">
                <div className="card card-dashboard-one">
                  <div className="card-header">
                    <div>
                      <h6 className="card-title">About Center of Excellence</h6>
                    </div>
                  </div>
              ...
              <div className="col-lg-6 mg-t-20 mg-lg-t-0">
                <div className="row row-sm">
                  <div className="col-sm-12">
                    <div className="card card-dashboard-two" style={{border: 'none'}}>
                      <div className="card-body" style={{boder: 'solid 2px #cdcdcd', borderRadius: '4px'}}>
                          {/* <img
                            src={require("../../assets/images/medco-logo.png")}
                            alt=""
                            style={{height: '320px'}}
                          ></img> */}
                      </div>{/* card-body */}
