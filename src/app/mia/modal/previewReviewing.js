...
function PreviewReviewing(props) {
  // const [roiValue, setRoiValue] = useState(props.row?.roi_value)

  // const displayROIValue = (roi) => {
  //   if (roi === '3') {
  //     return <span>High | <i>15-20%</i></span>
  //     // setRoiValue('High')
  //   }
  // }
  ...
  return (
    <Modal show={props.open} onHide={props.onClose} dialogClassName="custom-modal" >
      <Modal.Header closeButton>
        <Modal.Title><div className='div-icon'><i className="typcn typcn-eye"></i></div> Preview Reviewing</Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
export default PreviewReviewing;