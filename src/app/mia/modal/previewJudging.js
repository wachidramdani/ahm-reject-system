...
function PreviewJudging(props) {
  return (
    <Modal show={props.open} onHide={props.onClose} dialogClassName="custom-modal" >
      <Modal.Header closeButton>
        <Modal.Title><div className='div-icon'><i className="typcn typcn-eye"></i></div> Preview Judging</Modal.Title>
      </Modal.Header>
      <Modal.Body>
