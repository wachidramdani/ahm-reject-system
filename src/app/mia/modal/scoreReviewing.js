...
export class ScoreReviewing extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = (e, param) => {
    ...
    dataSubmit.forEach(el => {
      el.scoreReviewing = this.state.sp2
    })
    Swal.fire({
      title: 'Warning',
    ...
    return (
      <Modal show={this.props.open} onHide={this.props.onClose} dialogClassName="custom-modal" >
        <Modal.Header closeButton>
          <Modal.Title><div className='div-icon'><i className="typcn typcn-pencil"></i></div> Reviewing Score</Modal.Title>
        </Modal.Header>
        <Modal.Body>
